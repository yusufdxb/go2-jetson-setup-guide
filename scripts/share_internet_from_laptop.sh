...
echo "  These settings are stored in the go2-network profile and persist across reboots."
echo ""
echo -e "  ${GREEN}# Set the laptop as the default gateway (persistent)${NC}"
echo -e "  ${CYAN}sudo nmcli con mod go2-network ipv4.gateway $LAPTOP_IP${NC}"
echo ""
echo -e "  ${GREEN}# Set DNS (persistent)${NC}"
echo -e "  ${CYAN}sudo nmcli con mod go2-network ipv4.dns \"8.8.8.8 8.8.4.4\"${NC}"
echo ""
echo -e "  ${GREEN}# Apply changes${NC}"
echo -e "  ${CYAN}sudo nmcli con up go2-network${NC}"
echo ""
